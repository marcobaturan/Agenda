...
courses and students at Institute Sagan, Asimov & Clarke.
'''
from easygui import *
import os
import pprint
...
TITLE = "Course Register for Institute Sagan, Asimov & Clarke"
...
def reportResults(resultsSet, msg=""):
    if not debugging:
        return
    print("{0} fetched {1} rows".format(msg, len(resultsSet)))
